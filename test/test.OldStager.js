...
//          GameState.compare(stager.next('0.0.0'),'1.1.1')
//                 .should.be.equal(0);
//      });
//      it('should return 2.1.1', function() {
//          GameState.compare(stager.next('1.1.1'),'2.1.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.1.1', function() {
//          GameState.compare(stager.next('2.1.1'),'3.1.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.2.1', function() {
//          GameState.compare(stager.next('3.1.1'),'3.2.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.3.1', function() {
//          GameState.compare(stager.next('3.2.1'),'3.3.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.1.2', function() {
//          GameState.compare(stager.next('3.3.1'),'3.1.2')
//                 .should.be.equal(0);
//      });
//
...
//      it('should return 1.1.1', function() {
//          GameState.compare(stager.previous('2.1.1'),'1.1.1')
//                 .should.be.equal(0);
//      });
//      it('should return 2.1.1', function() {
//          GameState.compare(stager.previous('3.1.1'),'2.1.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.1.1', function() {
//          GameState.compare(stager.previous('3.2.1'),'3.1.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.2.1', function() {
//          GameState.compare(stager.previous('3.3.1'),'3.2.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.3.1', function() {
//          GameState.compare(stager.previous('3.1.2'),'3.3.1')
//                 .should.be.equal(0);
//      });
//
...
//      it('should return 2.1.1', function() {
//          GameState.compare(stager.jumpTo('1.1.1', 1), '2.1.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.1.1', function() {
//          GameState.compare(stager.jumpTo('3.1.1', 1), '3.2.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.2.1', function() {
//          GameState.compare(stager.jumpTo('3.3.1', 1), '3.1.2')
//                 .should.be.equal(0);
//      });
//      it('should return 3.3.1', function() {
//          GameState.compare(stager.jumpTo('3.1.1', 2), '3.3.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.3.1', function() {
//          GameState.compare(stager.jumpTo('3.1.1', 5), '3.3.2')
//                 .should.be.equal(0);
//      });
//      it('should return false at beginning of the stages', function() {
...
//          GameState.compare(stager.jumpTo('2.1.1', -1), '1.1.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.1.1 (jump -1)', function() {
//          GameState.compare(stager.jumpTo('3.2.1', -1), '3.1.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.3.1 (jump -1)', function() {
//          GameState.compare(stager.jumpTo('3.1.2', -1), '3.3.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.1.1 (jump -2)', function() {
//          GameState.compare(stager.jumpTo('3.3.1', -2), '3.1.1')
//                 .should.be.equal(0);
//      });
//      it('should return 3.1.1 (jump -5)', function() {
//          GameState.compare(stager.jumpTo('3.3.2', -5), '3.1.1')
//                 .should.be.equal(0);
//      });
//      it('should return false at beginning of the stages', function() {
