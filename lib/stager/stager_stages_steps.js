...
(function(exports, node) {
    ...
    function handleStageParameter(that, stage, method) {
        ...
        if ('object' === typeof stage) {
            ...
            // If both cb and steps are missing, adds the default cb
            // or link to an existing step with the same name.
            if (!stage.cb && !stage.steps) {
                if (that.steps[id]) stage.steps = [ id ];
                else stage.cb = that.getDefaultCb();
            }
