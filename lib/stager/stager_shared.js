...
(function(exports, node) {
    ...
    function addStageBlock(that, id, type, positions) {
        ...
        // TODO: Here is a problem. The previous block may contains multiple
        // steps blocks, and they all should be closed.
        if (that.currentType !== BLOCK_DEFAULT) {
            // console.log(that.unfinishedBlocks)
            console.log(that.currentType, type)
            that.endBlocks(2 + that.openStepBlocks);
            that.openStepBlocks = 0;
        }
        // that.currentType = BLOCK_DEFAULT; // TODO: do we need this line?
