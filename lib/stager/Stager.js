...
(function(exports, parent) {
    ...
    // TODO: is the __enclosing Block to mention here??
    ...
    Stager.prototype.stageBlock = function(positions, options) {
        ...
        if (this.currentType !== BLOCK_DEFAULT) {
            this.endBlocks(2);
        }
        this.currentType = BLOCK_DEFAULT;
    ...
    function handleStageAdd(that, stage, positions) {
        ...
        that.stageBlock(positions, { id: "__enclosing_" + name });
        ...
        that.stepBlock('linear', { id: "__steps_" + name });
    }
