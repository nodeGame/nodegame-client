 ...
 *
 * ```js
 * stager.stageBlock('First StageBlock', '*');
 * ```
 *
 ...
 * ```
 *
 * The last block in the `unfinishedBlocks` array removed, and a new
 * one for the new stage block is added. No enclosing stages and steps blocks
 * added yet.
 *
