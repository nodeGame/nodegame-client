...
(function(exports, parent) {
    ...
    // Do not change. These are shared with Stager.js.
    var BLOCK_DEFAULT     = '__default';
    var BLOCK_STAGEBLOCK  = '__stageBlock_';
    var BLOCK_STAGE       = '__stage';
    var BLOCK_STEPBLOCK   = '__stepBlock_';
    var BLOCK_STEP        = '__step';

    var BLOCK_ENCLOSING          = '__enclosing_';
    var BLOCK_ENCLOSING_STEPS    = '__enclosing_steps';
    var BLOCK_ENCLOSING_STAGES   = '__enclosing_stages';
    ...
    function Stager(stateObj) {
         ...
         */
        this.currentType = BLOCK_DEFAULT;
         ...
         */
        this.currentBlockType = BLOCK_DEFAULT;
        ...
        if (stateObj) {
            ...
            // Add first block.
            this.stageBlock(BLOCK_DEFAULT, 'linear');
        }
    }
    ...
    Stager.prototype.finalize = function() {
        ...
        while (!!currentItem) {
            if (currentItem.type === BLOCK_STAGE) {
    ...
    // TODO: move.
    function addBlock(that, positions, options) {
        var block;
    ...
    function addStageBlock(that, id, type, positions) {
        ...
        addBlock(that, id, type, positions, BLOCK_STEP);
    };
    ...
    function addBlock(that, id, type, positions, type2) {
        ...
        if (!type2) throw new Error('AHHHHHHHHHHHH');

        that.currentBlockType = type2; // BLOCK_STEP or BLOCK_STAGE;
        // TODO: maybe an IF would do it.
    ...
    Stager.prototype.stepBlock = function() {
        ...
        if ('string' !== typeof positions &&
            'number' !== typeof positions &&
            'undefined' !== typeof positions) {

            throw new TypeError('Stager.stageBlock: positions must be ' +
                                'string, number or undefined: ' + positions);
        }

//        this.currentBlockType = BLOCK_STEP;

//         options = options || {};
//         if ('undefined' === typeof options.id) {
//             options.id = BLOCK_STEPBLOCK + J.randomInt(1000);
//         }
//         if ('undefined' === typeof options.type) {
//             options.type = BLOCK_STEPBLOCK;
//         }
//         addBlock(this, positions, options);
...
//        this.currentBlockType = BLOCK_STAGE;

//         options = options || {};
//         if ('undefined' === typeof options.id) {
//                 options.id = BLOCK_STAGEBLOCK + J.randomInt(1000);
//         }
//         if ('undefined' === typeof options.type) {
//             options.type = BLOCK_STAGEBLOCK;
//         }
...
//         that.stageBlock(positions, {
//             id: BLOCK_ENCLOSING + name + rndName,
//             type: BLOCK_ENCLOSING_STAGES
//         });
...
//         that.stepBlock('linear', {
//             id:   BLOCK_ENCLOSING + name + '_steps' + rndName,
//             type: BLOCK_ENCLOSING_STEPS
//         });
...
//     var block;
//     options = options || {};
//     options.type = this.currentBlockType;
//
//     block = new Block(positions, options);
...
//     this.endBlock();
//     if (this.currentBlockType === BLOCK_STAGE) {
//         this.stageBlock(positions, options);
//     }
//     else if (this.currentBlockType === BLOCK_STEP) {
