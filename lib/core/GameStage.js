 ...
 */		
	...
	if ('string' === typeof gs) {
		...
		this.stage = ('undefined' !== typeof tokens[0]) ?
			(!isNaN(stageNum) ? stageNum : tokens[0]) : undefined;
		this.step  = ('undefined' !== typeof tokens[1]) ?
			(!isNaN(stepNum)  ? stepNum  : tokens[1]) : undefined;
		this.round = ('undefined' !== typeof tokens[2]) ? roundNum : undefined;
	}
