 ...
 */
GameStage.defaults.hash = 'S.s.r.p';
 ...
 */		
	...
	if ('string' === typeof gs) {
		var tokens = gs.split('.');		
		this.stage = 	('undefined' !== typeof tokens[0]) ? Number(tokens[0]) : undefined;
...
GameStage.toHash = function (gs, str) {
	...
	var hash = '',
		symbols = 'Ssrp',
		properties = ['stage', 'step', 'round', 'paused'];
 ...
 * 
 * The accepted hash string format is the following: 'S.s.r.p'.
