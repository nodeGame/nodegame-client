...
GameLoop.prototype.next = function (curStage) {
	...
	if (flexibleMode) {
		...
		curStage.stage = (typeof(curStage.stage) !== 'undefined') ? curStage.stage : 0;
		curStage.step  = (typeof(curStage.step)  !== 'undefined') ? curStage.step  : 1;
		curStage.round = (typeof(curStage.round) !== 'undefined') ? curStage.round : 1;
