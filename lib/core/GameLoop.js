...
//		node.warn('Stage property key must be an array.');
//		return;
//	}
//	
//	var steps = [], step, i;
//	for (i = 0 ; i < stage.steps.length ; i++) {
//		step = new GameStep(stage.steps[i]);
//		if (!step) continue;
//		steps.push(step);
//	}
//	
...
// */
//Stager.prototype.exist = function (sta) {
...
// */
//Stager.prototype.previous = function (gameState) {
//	gameState = new GameState(gameState);
//	
//	if (!this.exist(gameState)) {
//		return false;
...
//	if (N < 0) {
//		node.warn('#Stager.next(): N must be > 0');
//		return false;
//	}
//	
//	
...
//	}
//	
//	return jumpTo.call(this, gameState, N);
//};
//
//function jumptTo(gameState, N) {
