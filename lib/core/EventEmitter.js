...
EventEmitter.prototype.on = function (type, listener) {
    ...
    node.debug(this.name + ': added Listener: ' + type + ' ' + listener);  
};
 ...
 */
	...
	for (var i in this.events) {
		...
		console.log('Event: ' i + ' has ' + i.length ? i.length : 1 + ' listener/s');
            }
	}
    };
 ...
 */
    ...
    EventEmitterManager.prototype.emit = function(event) {
	var i;
