...
(function(exports, parent) {
     ...
     * @param {string} label Optional. If set, it flags the listener with
    ...
    EventEmitter.prototype.on = function(type, listener, label) {
        ...
        if (label && 'string' !== typeof label) {
            throw new TypeError('EventEmitter.on: label must be string or ' +
                                'undefined.');
        }
                ...
                if ('function' === typeof this.events[type]) {
                    ...
                    if ('function' === typeof listener) {
                        ...
                        if (listener === listeners[i].__ngid ||
                            listener === J.funcName(listeners[i])) {
                            oneFound = true;
                        }
                    }
