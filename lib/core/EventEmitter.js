...
(function(exports, parent) {
    ...
    EventEmitterManager.prototype.remove = function(eventName, listener) {
        ...
        res = false;
        tmpRes = this.ng.remove(eventName, listener);
        res = res || !!tmpRes.length;
        tmpRes = this.game.remove(eventName, listener);
        res = res || !!tmpRes.length;
        tmpRes = this.stage.remove(eventName, listener);
        res = res || !!tmpRes.length;
        tmpRes = this.step.remove(eventName, listener);
        res = res || !!tmpRes.length;
