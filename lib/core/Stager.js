...
Stager.prototype.clear = function() {
	 ...
	 *
	 * Called to yield the id of the next game stage.
	 *
 ...
 *  the next stage or false to end the game.
 */
 ...
 *
 * Used in flexible mode.
 * The callback given here is used to determine the next stage after a specific stage.
 *
 * @param {string} id The stage to associate the decider with
 * @param {function} func The decider callback.  It should return the name of
 *  the next stage or false to end the game.
 */
 ...
 *
 * @param {string} format 'h' to return an array of human-readable strings,
 *  'o' to return the internal JavaScript object
 *
 * @return {array|object} The stage sequence
 */
