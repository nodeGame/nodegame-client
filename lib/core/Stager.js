...
(function(exports, parent) {
    ...
    Stager.prototype.addStage = function(stage) {
        ...
        // we do a mixin here to preserve links between aliases
    ...
    /**
     * ### Stager.registerStageName
     *
     * Registers a given stage name.
     *
     * Takes a string like 'stageID' and checks whether it is registered
     * already. If not, it creates a default call back that will log the
     * stageName to the console.
     * Will return the implementation.
     *
     * @param {string} stageName The name of the stage to be registered
     *
     * @return {object|null} NULL on error,
     *  the associated stage otherwise
     *
     * @see Stager.addStage
     *
     * @api private
     */
    Stager.prototype.registerStageName = function(stageName) {
        if (!stageName) {
            throw new Error('Stager.registerStageName: ' +
                            'received invalid stageName');
           return null;
        }
