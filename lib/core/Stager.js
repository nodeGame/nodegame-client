...
(function(exports, parent) {
    ...
    Block.prototype.add = function(item, positions) {
        ...
        if (positions === 'linear') {
            ...
            Positions =
                J.mixout(TODO.parseInput(positions), this.takenPositions);
        }
    ...
    Block.prototype.finalize = function() {
        ...
        while(this.unfinishedEntries.length > 0) {
            ...
            this.unfinishedItems.sort(function(left, right) {
    ...
    Stager.prototype.endBlock - function() {
    ...
    Stager.prototype.endBlocks = function(n) {
        var i;
        for (i = 0; i < n; ++i) {
            this.endBlock();
        }
