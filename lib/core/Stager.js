...
(function(exports, parent) {
    ...
    Stager.prototype.extendStage = function(stageId, update) {
        ...
        if ('object' === typeof update) {
            if (update === null) {
                throw new TypeError('Stager.extendStage: update is null.');
            }
            if (update.hasOwnProperty('id')) {
            ...
            if (update.hasOwnProperty('steps') &&
                ...
                throw new TypeError('Stager.extendStage: if defined ' +
                                    'update.steps must be a non-empty array.');
            }
            ...
            if (stage.id !== stageId) {
                throw new TypeError('Stager.extendStage: update function ' +
                                    'cannot alter id property.');
            }

            // TODO CONTINUE HERE (check stage).
