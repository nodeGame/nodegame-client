...
// id has form 'stageID' or 'stageID AS alias'.
...
// Add loop (executed only if func returns true) to sequence.
// Returns this on success, null on failure.
...
// Add do-loop (executed at least once) to sequence.
// Returns this on success, null on failure.
...
// Handles stage id and alias.
// Takes e.g. 'stageID' or 'stageID AS alias' and registers the possible alias.
// Checks whether argument is valid and unique.
// Returns null on failure, alias if existent, stageID otherwise.
