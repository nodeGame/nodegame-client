...
(function(exports, parent) {
    ...
    Stager.prototype.clear = function() {
         ...
         * ### Stager.finalized
         *
         * Flag indicating if the hierarchy of stages and steps has been fixed
         */
         ...
         * ### Stager.currentType
         *
         * Name of the stage currently worked with when building hierarchy
         */
         ...
         *
         * Default steps are either none if any step is defined for that stage
         * and a step with the same name as the stage otherwise.
         */
        this.defaultSteps = {};
    ...
    Stager.prototype.init = function() {
        this.sequence = [];
        this.stageBlock("linear","__default_block");
        return this;
    };
     ...
     * @see Stager.addStage
     */
    Stager.prototype.next = function(stage, positions, cb) {
        var i,I, id = ("string" === typeof(stage) ? stage : stage.id);
    ...
    Stager.prototype.handleStageAdd = function(stage, positions) {
        ...
        this.beginBlock(positions, {id: "__enclosing_" + stage.id || stage.type});

        this.getCurrentBlock().add({
            type: "__stage",
            item: stage,
        });
        this.currentType = stage.id || stage.type;

        // Add step block inside stage block.
        this.beginBlock('linear',{id: "__steps_" + stage.id || stage.type});
    }
    ...
    Stager.prototype.finalize = function() {
        ...
        for (type in this.defaultSteps) {
            if (this.defaultSteps.hasOwnProperty(type)) {
                this.stages[type].steps = J.clone(this.defaultSteps[type]);
            }
        }
     ...
     *
     * Allows to call Stager.finalize again to build a potentially different
     * sequence from the Block hierarchy.
     */
