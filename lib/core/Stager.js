...
(function(exports, parent) {
    ...
    Stager.prototype.setDefaultGlobals = function(defaultGlobals) {
        if (!defaultGlobals || 'object' !== typeof defaultGlobals) {
            throw new TypeError('Stager.setDefaultGlobals: ' +
                                'defaultGlobals must be object or ' +
                                'undefined.');
        }
     ...
     * @see GamePlot.getProperty
     */
    Stager.prototype.setDefaultProperties =
    ...
    Stager.prototype.next = function(stage, positions, cb) {
        ...
        if (stageName === null) {
            throw new Error('Stager.next: invalid stage name' +
                            ' received.');
        }
    ...
    Stager.prototype.handleStageAdd = function(stage, positions) {
        ...
        this.beginBlock(positions, {
            id: "__enclosing_" + stage.id || stage.type
        });
        ...
        this.beginBlock('linear',{
            id: "__steps_" + stage.id || stage.type
        });
    }
    ...
    function handleAlias(that, nameAndAlias, cb) {
        if ('object' !== typeof that) {
            throw new TypeError('Stager.handleAlias: that must' +
                                ' be object.');
        }
