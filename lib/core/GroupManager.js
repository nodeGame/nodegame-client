...
(function(exports, node) {
     ...
     *
     */
    GroupManager.prototype.setElements = function(elements) {
     ...
     *
     */
    GroupManager.prototype.assign2Group = function(groupName, players) {
        ...
        else if ('object' === typeof players && players instanceof PlayerList) {
            players = players.id.getAllKeys();
        }
        else if(!J.isArray(players)) {
            throw new TypeError('node.group.assign2Group: players must be ' +
                                'string, array, or instance of PlayerList.');
        }

        i = -1, len = players.length;
        for ( ; ++i < len ; ) {
            add2Group(group, players[i], 'assign2Group');
        }
    };
    ...
    GroupManager.prototype.getMemberships = function() {
