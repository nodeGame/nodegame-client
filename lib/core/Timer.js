...
(function(exports, parent) {
    ...
    Timer.prototype.randomEmit = function(event, maxWait) {
        ...
        randomFire.call('randomEmit', this, event, maxWait, true);
    };
    ...
    Timer.prototype.randomExec = function(func, maxWait, ctx) {
        ...
        randomFire.call('randomExec', this, func, maxWait, false, ctx);
    };
    ...
    Timer.prototype.randomDone = function(maxWait) {
        randomFire.call('randomDone',
                        this, this.node.done, maxWait, false, this.node);
    };
