 ...
 */
	...
	prefix = prefix ? 'ng> info ' : 'ng|' + prefix + '> info ';
 ...
 */
	...
	prefix = prefix ? 'ng> warn ' : 'ng|' + prefix + '> warn ';
 ...
 */
	...
	prefix = prefix ? 'ng|' + prefix + '> error ' : 'ng> error ';
 ...
 */
    node.debug = function (txt, prefix) {
	prefix = prefix ? 'ng> debug ' : 'ng|' + prefix + '> debug ';
	node.log(txt, node.verbosity_levels.DEBUG, prefix);
    };
