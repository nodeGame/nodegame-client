...
(function (exports, node) {
	...
	node.is = {};
	node.is.UNKNOWN = 0; 		// Game has not been initialized
	node.is.LOADING = 10;		// The game is loading
	node.is.LOADED  = 25;		// Game is loaded, but the GameWindow could still require some time
	node.is.PLAYING = 50;		// Everything is ready
	node.is.DONE = 100;		// The player completed the game state
