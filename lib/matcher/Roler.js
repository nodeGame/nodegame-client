...
(function(exports, parent) {
     ...
     * ### Roler.getRole2IdMap
     *
     * Returns the requested role to id mapping
     *
     * @param {number} x The round of the roles
     * @param {number} y Optional. The y-th role within round x
     *
     ...
     * @see Roler.role2IdRoundMap
     */
    Roler.prototype.getRole2IdMap = function(x, y) {
        if ('number' !== typeof x || x < 0 || isNaN(x)) {
            throw new TypeError('Roler.getRole2IdMap: x must be a ' +
                                'non-negative number. Found: ' + x);
        }
        if ('undefined' === typeof y) {
        ...
        if ('number' !== typeof y || y < 0 || isNaN(y)) {
            throw new TypeError('Roler.getRole2IdMap: y must be a ' +
     ...
     * @see Roler.matchedRoles
     */
    Roler.prototype.getId2RoleMap = function(x, y) {
        if ('number' !== typeof x || x < 0 || isNaN(x)) {
            throw new TypeError('Roler.getId2RoleMap: x must be a ' +
                                'non-negative number. Found: ' + x);
        }
        if ('undefined' === typeof y) {
        ...
        if ('number' !== typeof y || y < 0 || isNaN(y)) {
            throw new TypeError('Roler.getId2RoleMap: y must be a ' +
                                'non-negative number. Found: ' + y);
        }
