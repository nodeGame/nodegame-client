...
(function(exports, parent) {
     ...
     *
     * @see Roler.rolesMap
     * @see Roler.rolesMapObj
     * @see Roler.rolesMapObjById
     */
    Roler.prototype.rolifyAll = function(matches) {
        ...
        this.rolesMap = rolesMap;
        this.rolesMapObj = rolesObj;
        this.rolesMapObjById = idRolesObj;
     ...
     *      b) an array of length 2 (role: id1, id2) [only if invoking
     *         method is setRolesMapObj]
     *
