...
(function(exports, parent) {
     ...
     * @see Roler.matchedRoles
     */
    Roler.prototype.setRole2IdMatches = function(map, validate) {
        if ('undefined' === typeof validate || !!validate) {
            validateRolesMapObj('setRole2IdMatches', map);
        }
        this.role2IdMatches = map;
    };
     ...
     */
    Roler.prototype.setId2RoleMatches = function(map, validate) {
        if ('undefined' === typeof validate || !!validate) {
            validateRolesMapObj('setId2RoleMatches', map);
        }
        this.id2RoleMatches = map;
    };
