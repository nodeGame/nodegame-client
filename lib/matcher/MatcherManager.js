...
(function(exports, parent) {
    ...
    MatcherManager.prototype.getMatches = function() {
        ...
        if (mod === 'ARRAY_ID_ROLES') return this.roler.getId2RoleMap(round);
        if (mod === 'ARRAY_ROLES_ID') return this.roler.getRole2IdMap(round);
    ...
    function randomPairs(settings) {
        ...
        matchedRoles = this.roler.getMatchedRoles();
