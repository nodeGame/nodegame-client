...
(function(exports, parent) {
     ...
     *
     * Executes a callback function on all the requested matches
     *
     * Accepts a variable number of parameters. TODO: finish.
     */
    MatcherManager.prototype.each = function() {
        // TODO.
    };
     ...
     *
     * Accepts two parameters to specify a round other than current,
     * and a modifier for the return value. Important! Both parameters
     * are optional and they can be passed in either order.
     *
    ...
    MatcherManager.prototype.getMatches = function() {
        ...
        if (mod === 'ARRAY_ROLES') return this.matcher.getMatch(round);
