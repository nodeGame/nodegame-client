...
(function(exports, parent) {
    ...
    function randomPairs(settings) {
        ...
        var i, len;
        var roundMatches, match, id1, id2, soloId;
        ...
        // or if reInit = true).
        else if (!this.matcher.matches || settings.reInit) {
