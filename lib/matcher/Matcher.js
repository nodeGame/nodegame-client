...
//     };
     ...
     *
     * Populates the objects `resolvedMatchesObj` and `resolvedMatches`.
     *
    ...
    Matcher.prototype.match = function(assignIds) {
        ...
        this.resolvedMatchesObj = matchedId;
    ...
    Matcher.prototype.getMatchFor = function(id, x) {
        ...
        if (!this.idsMap || !this.idsMap[id]) {
            throw new TypeError('Matcher.getMatchFor: unknown id: ' + id);
        }
        return hasOrGetNext.call(this, 'getMatchFor', 2, x, id);
    };
    ...
    fetchMatch = [
        ...
        // getMatchFor.
        function(x, id) {
            if ('number' === typeof x) return this.resolvedMatchesObj[x][id];
            else return this.rs
        },
        // getMatchObject.
        function(x, y) {
     ...
     * @see fetchMatch
     */
    function hasOrGetNext(m, mod, x, y) {
        ...
        if ('undefined' === typeof x) {
            ...
            if (null === this.x) {
                this.x = 0;
                this.y = 0;
                return fetchMatch[mod].call(this, 0, 0);
            }
        ...
        if ('undefined' === typeof y) {
            if (mod) {
                ...
                return fetchMatch[mod].call(this, x);
        ...
        if ('number' !== typeof y) {
            ...
            throw new Error('Matcher.' + m + ': y cannot be negative');
        }
